create temporary table paises(codigo int, nome varchar(300), nomeEN varchar(500));

INSERT INTO paises (codigo, nome, nomeEN) 
VALUES
...
insert into status_pedido(Codigo,Nome)
values (1,'Atendido'), (2,'Não Atendido'), (3,'Parcialmente Atendido'), (4,'Não Classificado');

insert into tipo_pedido_resposta(Codigo,Nome)
values 
(1,'Resposta do órgão público'), 
(2,'Reclamação'), 
(3,'Resposta da Reclamação'), 
(4,'Recurso - 1º Instância'), 
(5,'Resposta do recurso - 1º Instância'), 
(6,'Recurso - 2º Instância'), 
(7,'Resposta do recurso - 2º Instância'), 
(8,'Recurso - 3º Instância'), 
(9,'Resposta do recurso - 3º Instância'),
(10,'Recurso - 4º Judicial'),
(11,'Resposta do recurso - 4º Judicial');

insert into tipo_pedido_origem(Codigo,Nome) 
values (1,'Site'), (2,'Admin'), (3,'Importação');

insert into tipo_poder(Codigo,Nome)
values(1,'Legislativo e Tribunais de Contas'), (2,'Executivo'), (3,'Judiciário'), (4,'Ministério Público');

insert into tipo_nivel_federativo(Codigo,Nome)
values(1,'Federal'), (2,'Estadual'), (3,'Municipal');