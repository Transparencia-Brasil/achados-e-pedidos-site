			...
			<div class="row-fluid">	
				...
				<a class="quick-button metro yellow span2" href="<?=$this->Url->build(['controller' => 'Usuarios', 'action' =>'index'])?>">
					<i class="icon-group"></i>
					<p>Usuários</p>
					<span class="badge"></span>
				</a>
				<a class="quick-button metro red span2" href="<?=$this->Url->build(['controller' => 'Pedidos', 'action' =>'index'])?>">
					<i class="icon-comments-alt"></i>
					<p>Pedidos</p>
					<span class="badge"></span>
				</a>
				<a class="quick-button metro blue span2" href="<?=$this->Url->build(['controller' => 'Moderacao', 'action' =>'index'])?>">
					<i class="icon-barcode"></i>
					<p>Moderação</p>
					<span class="badge"></span>
				</a>
				<a class="quick-button metro black span2" href="<?=$this->Url->build(['controller' => 'Cursos', 'action' =>'index'])?>">
			...
			<div class="row-fluid" >
				...
				<div class="box black span4" onTablet="span6" onDesktop="span4" >
					<div class="box-header">
						<h2><i class="halflings-icon white user"></i><span class="break"></span>Últimos usuários cadastrados</h2>
						<div class="box-icon">
							<a href="#" class="btn-minimize"><i class="halflings-icon white chevron-up"></i></a>
							<a href="#" class="btn-close"><i class="halflings-icon white remove"></i></a>
						</div>
